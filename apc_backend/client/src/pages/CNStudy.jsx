...
export default function CNStudy() {
  const navigate = useNavigate();

  const studyOptions = [
    { name: "Questions", icon: BookOpen, path: "/practice/core/study/CN/questions" }
  ];
  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-500">
      <header>
        ...
        <h1 className="text-4xl font-extrabold text-white tracking-tight">Computer Networks</h1>
        <p className="text-slate-400 mt-3 text-lg max-w-2xl leading-relaxed">
          Master Computer Networks concepts including protocols, architecture, security, and performance.</p>
      </header>
        ...
        {studyOptions.map((option) => {
          return (
            ...
            >
              ...
              <p className="text-slate-400 text-sm">Explore {option.name.toLowerCase()} for CN.</p>
            </button>
          );
        })}
      </div>
